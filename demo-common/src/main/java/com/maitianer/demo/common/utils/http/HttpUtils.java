package com.maitianer.demo.common.utils.http;
    ...
    public static String downloadFile(String fileURL, String saveDir){
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                throw new CommonBaseException(responseCode, "下载失败");
            }
        } catch (IOException e) {
            throw new CommonBaseException(500, "下载失败", e);
        }finally {
    ...
    public static HttpResponseEntity post(String requestUri,HttpRequestEntity requestEntity) {
        ...
        try {
            if(requestEntity.getFileParams().isEmpty()){
                ...
                // 组装文本请求参数
                Set<Map.Entry<String, String>> textEntrySet = requestEntity.getTextParams().entrySet();
...
//		}
    ...
    public static String getBodyString(ServletRequest request) {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(inputStream, Charset.forName(CHARSET_UTF_8)));
            String line = "";
