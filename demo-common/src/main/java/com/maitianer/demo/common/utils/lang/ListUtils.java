package com.maitianer.demo.common.utils.lang;

import com.maitianer.demo.common.callback.MethodCallback;
import com.maitianer.demo.common.utils.ReflectUtils;
                ...
                Collections.sort(list, new Comparator<T>() {
                    public int compare(T o1, T o2) {
                        ...
                        if (o1 instanceof Map){
                            ...
                            s1 = Objects.toString(ReflectUtils.invokeGetter(o1, ss[0]));
                            s2 = Objects.toString(ReflectUtils.invokeGetter(o2, ss[0]));
                        }
                        if ("asc".equals(ss[1])){
