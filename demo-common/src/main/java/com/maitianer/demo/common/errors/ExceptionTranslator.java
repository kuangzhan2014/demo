 ...
 */
public class ExceptionTranslator implements CustomProblemHandling {
...
//    @ExceptionHandler
//    public ResponseEntity<Problem> handleAuthenticationException(AccessDeniedException ex, NativeWebRequest request) {
//        Problem problem = Problem.builder()
